    ...
    display(){
      ...
      this.PlayButton.mousePressed(()=>{
        ...
        // this.PlayButton.hide();
         ...
         var heading=createDiv('Morning of 21st Jan,1930')  
                             
         heading.position(displayWidth/2-500,300)
         heading.style('color',"white")
         heading.style('font-size', '70px')

         var StoryTillNow=createDiv('Me and my friend took off for hiking on this mountain 5 days ago. We lost our way and we could not find our way back. There are clouds everywhere.Things got worse yesterday, when my friend disappeared in a dark cave. He started screaming, but I could not risk my life to save his. I tried to find someone for help, and today I have come across this little, neat house. I hope someone lives here....')  
