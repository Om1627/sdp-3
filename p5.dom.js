...
// =============================================================================
   ...
   * Use .size() to set the display size of the press.
   * Appends to the container node if one is spe button.
   * Use .mousePressed() to specify behavior oncified, otherwise
   * appends to body.
   *
   * @method createButton
